...
y = 5
assert(y >= 0), 'Y is not positive!!!' #*Will throw assertion error if assertion is not true!!
...
class ValueTooHighError (Exception):        #*It is good to give these classes names with Error at the end
    pass
